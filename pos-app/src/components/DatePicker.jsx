// Ported verbatim from website/src/components/DatePicker.jsx — custom
// <input type="date"> replacement (calendar popover via createPortal) used
// throughout AdminInventory.jsx's port (period filters, expiry/delivery/due
// dates, payment date). Only the `useTranslation` import path was adjusted —
// one level up from src/components/ to src/context/, same relative depth as
// the website's own '../context/LanguageContext', just with the .js file's
// explicit .jsx extension (same convention ConfirmDialog.jsx already uses).
// No markup/logic changed.
