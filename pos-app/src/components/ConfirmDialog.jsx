// ─────────────────────────────────────────────────────────────────────────────
// Ported verbatim from website/src/components/ConfirmDialog.jsx — a styled
// replacement for window.confirm/alert used by AdminMenu.jsx (station delete
// confirm + upload-issue/upload-failed notices). Only the import path for
// useTranslation was adjusted (one level deeper here: src/components/ instead
// of website's src/components/, but pos-app's context lives at
// src/context/LanguageContext.jsx, i.e. the same relative depth as the
// website's own '../context/LanguageContext'). No logic/markup changed.
// ─────────────────────────────────────────────────────────────────────────────
