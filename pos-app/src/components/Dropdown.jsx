// Ported verbatim from website/src/components/Dropdown.jsx — custom <select>
// replacement used throughout AdminInventory.jsx's port (status/category/unit
// filters, and every form dropdown). No changes at all: this component has no
// context/translation dependency and no relative imports outside lucide-react,
// so nothing needed adjusting for pos-app's file layout.
